                ...
                $result_tasks = mysqli_query($conn, $query);      
                    ...
                    while($row = mysqli_fetch_assoc($result_tasks)) { 
                        ...
                        <tr>
                            ...
                            <a title="Eliminar" href="../includes/delete_cliente_super_user.php?id=<?php echo $id;?>" style="color: #17A589; padding:2%; ">
                            ...
                            <div class="modal-body">   
                                <form action="../formularios/edit_cliente.php?id=<?php echo $id; ?>" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_cliente_super_user" class="btn btn-primary">Editar</button> 
                                        </div>
                                        <div class="col-sm-2">
            ...
            <form action="../formularios/edit_cliente.php" method="POST">
                ...
                <div class="row form-group">
                    ...
                    <div style="text-align:center;" class="col-sm-2">
                        <button type="submit" name="agregar_cliente_super_user" class="btn btn-primary">Agregar Cliente</button> 
                    </div>
                    <div class="col-sm-5"></div>
                </div>            
            </form>
