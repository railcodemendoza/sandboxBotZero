...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM `customer.shipper` WHERE company = '$empresa'";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a title="Editar Shipper" data-toggle="modal" data-target="#editar<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a title="Ver Shipper" data-toggle="modal" data-target="#ver<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a title="Eliminar" href="../includes/delete_shipper.php?id=<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar Shipper <strong><?php echo $razon_social; ?></strong></h4>
                            </div>
                            <div class="modal-body">
                                <form action="../formularios/edit_shipper.php?id=<?php echo $id; ?>" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="text" name="city" value="<?php echo $city; ?>">
                                        </div>
                                        <div class="col-sm-1 pt-2">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" style="margin-right: 1%; " type="text" name="postal_code" value="<?php echo $postal_code; ?>">
                                        </div>
                                        <div class="col-sm-2 mt-1">
                                            <label class="form-control-label">Remarks:</label>
                                        </div>
                                        <div class="col-sm-3 mt-1">
                                            <textarea name="remarks" placeholder="<?php echo $remarks; ?>" cols="85" rows="5" class="form-control"><?php echo $remarks; ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_shipper" class="btn btn-primary">Editar</button>
                                        </div>
                                        <div class="col-sm-2">
                ...
                <div class="modal fade" id="ver<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Detalles <strong><?php echo $razon_social; ?></strong></h4>
                            </div>
                            <div class="modal-body">
                                <form action="../formularios/editMisShipper.php" method="POST">
                                    <div class="row">
                                        <div class="col-sm-2 pt-2">
                                            <label class="form-control-label" for="">Razon Social:</label>
                                        </div>
        ...
        <form action="../Report_Customer/misShipper.php" method="POST">
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA" class="btn btn-outline-primary">Agregar Shipper</button>
                </div>
            </div>
        </form>
        <br>
...
<div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="../formularios/misShipper.php" method="POST">
                <div class="row form-group">
                    <div class="col-sm-2 pt-2">
                        <label class="form-control-label" for="">Razon Social:</label>
                    </div>
                    <div class="col-sm-3">
                        <input class="form-control" type="text" name="razon_social" placeholder="Empresa SA" required>
                    </div>
                    <div class="col-sm-1 pt-2">
                        <label class="form-control-label" for="">Tax ID:</label>
                    </div>
                    <div class="col-sm-3">
                        <input class="form-control" type="number" name="tax_id" placeholder="CUIT / RUT / NIT" required>
                        <p>(sin guiones)</p>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control" style="margin-right: 1%; " type="text" name="postal_code" placeholder="10001" required>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-2 mt-1">
                ...
                <div class="row form-group">
                    <div class="col-sm-5"></div>
                    <div class="col-sm-2">
                        <button type="submit" name="cargar_shipper" class="btn btn-primary">Agregar Shipper</button>
                    </div>
                    <div class="col-sm-5"></div>
