<div class="container">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="../formularios/edit_modo_de_pago.php?id=<?php echo $id; ?>"
                                        method="POST">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <button type="submit" name="editar_modo_de_pago"
            ...
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA"
                        class="btn btn-outline-primary">Agregar Modo de Pago</button>
                </div>
            </div>
        </form>
        <br>
    ...
    <div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Modo de
                            Pago</strong>
                    </h4>
                </div>
                <div class="modal-body">
                    <form action="../formularios/edit_modo_de_pago.php?id=<?php echo $id; ?>" method="POST">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="title"
                                        placeholder="Transferencia Internacional">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2 pt-2">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="description"
                                        placeholder="Transferencias realizadas por medio de SWIFT">
                                </div>
                            </div>
                            <br>
                            <div class="row form-group">
                                ...
                                <div style="text-align:center;" class="col-sm-2">
                                    <button type="submit" name="agregar_modo_de_pago" class="btn btn-primary">Agregar
                                        Modo</button>
                                </div>
                                <div class="col-sm-5"></div>
                            </div>
