                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a title="Eliminar" href="../includes/delete_cliente_super_user.php?id=<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar
                                        Cliente <strong><?php echo $razon_social; ?></strong></h4>
                                </div>
                                    ...
                                    <form action="../formularios/edit_cliente.php?id=<?php echo $id; ?>" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control" type="number" name="iibb"
                                                        value="<?php echo $iibb; ?>">
                                                    <p>(sin guiones)</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input class="form-control" style="margin-right: 1%; margin-left:1%;"
                                                    type="text" name="ciudad" value="<?php echo $ciudad; ?>">
                                            </div>
                                            <div class="col-sm-1 pt-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" style="margin-right: 1%; " type="text"
                                                        name="name_logistic" value="<?php echo $name_logistic; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2 pt-2">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control"
                                                        style="margin-right: 1%; margin-left:1%;" type="text"
                                                        name="cel_logistic" value="<?php echo $cel_logistic; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control"
                                                        style="margin-right: 1%; margin-left:1%;" type="text"
                                                        name="mail_logistic" value="<?php echo $mail_logistic; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" style="margin-right: 1%; " type="text"
                                                        name="name_admin" value="<?php echo $name_admin; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2 pt-2">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control"
                                                        style="margin-right: 1%; margin-left:1%;" type="text"
                                                        name="cel_admin" value="<?php echo $cel_admin; ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-2 pt-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control"
                                                        style="margin-right: 1%; margin-left:1%;" type="text"
                                                        name="mail_admin" value="<?php echo $mail_admin; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
            ...
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA"
                        class="btn btn-outline-primary">Agregar Cliente</button>
                </div>
            </div>
        </form>
        <br>
    ...
    <div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../formularios/edit_cliente.php" method="POST">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-2 pt-2">
                                    <label class="form-control-label" for="">Razon Social:</label>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" style="margin-right: 1%; " type="text" name="direccion"
                                    placeholder="Calle ##">
                            </div>
                            <div class="col-sm-1 pt-2">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="text"
                                    name="country" placeholder="Argentina">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="phone"
                                        name="cel_logistic" placeholder="542612128105">
                                    <p> Número plano ej: 542612128105</p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="email"
                                        name="mail_logistic" placeholder="juanperez@transporte.com.ar">
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="text"
                                        name="cel_admin" placeholder="542612128105">
                                    <p> Número plano ej: 542612128105</p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="text"
                                        name="mail_admin" placeholder="otrojuanperez@transporte.com.ar">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div style="text-align:center;" class="col-sm-2">
                                <button type="submit" name="agregar_cliente_super_user" class="btn btn-primary">Agregar
                                    Cliente</button>
                            </div>
                            <div class="col-sm-5"></div>
                        </div>
