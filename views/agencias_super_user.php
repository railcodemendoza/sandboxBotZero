                ...
                $result_tasks = mysqli_query($conn, $query);                        
                    while($row = mysqli_fetch_assoc($result_tasks)) {
                        ...
                        <tr>
                            ...
                            <a title="Eliminar" href="../includes/delete_agencia_super_user.php?id=<?php echo $id;?>" style="color: #17A589; padding:2%;" >
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content" >
                            ...
                            <div class="modal-body">   
                                <form action="../formularios/edit_agencias_super_user.php?id=<?php echo $id; ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2"><h4>Contacto:</h4></div>
                                    <div class="col-sm-5"><hr></div>
                                </div>
                                <div class="row form-group">    
                                    <div class="col-sm-2 pt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4"><h4 style="text-align: center; padding-top:0.5rem;">Contacto</h4></div>
                                            <div class="col-sm-4"><hr></div>
                                        </div>                                     
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4"><hr></div>
                                            <div class="col-sm-4"><h4 style="text-align: center; padding-top:0.5rem;">observaciones:</h4></div>
                                            <div class="col-sm-4"><hr></div>
                                        </div>  
                                        <div class="row">
