                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <a title="Eliminar" href="../includes/delete_consignee.php?id=<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                            ...
                            <div class="modal-body">
                                <form action="../formularios/edit_consignee.php?id=<?php echo $id; ?>" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_consignee" class="btn btn-primary">Editar</button>
                                        </div>
                                        <div class="col-sm-2">
        ...
        <form action="../Report_Customer/misConsignee.php" method="POST">
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA" class="btn btn-outline-primary">Agregar Consignee</button>
...
<div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Consignee</strong>
                </h4>
            </div>
            <div class="modal-body">
            <form action="../formularios/misConsignee.php" method="POST">
                ...
                <div class="row form-group">
                    <div class="col-sm-5"></div>
                    <div class="col-sm-2">
                        <button type="submit" name="cargar_consignee" class="btn btn-primary">Agregar Consignee</button>
                    </div>
                    <div class="col-sm-5"></div>
