                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                <a title="Eliminar" href="../includes/delete_chofer.php?id=<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
    ...
    <form action="../Reporte_user_basic/misChoferes.php" method="POST">
        <div class="row">
            <div class="col-sm-6 mx-auto text-center">
                ...
                <button type="button" data-toggle="modal" data-target="#agregarATA" class="btn btn-outline-primary">Agregar Chofer</button>
            </div>
        </div>
    </form>
    <br>
...
<div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Chofer</strong></h4>
            </div>
            <div class="modal-body">
                <form action="../formularios/edit_chofer.php" method="POST">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-5"></div>
                        <div class="col-sm-2">
                            <button type="submit" name="agregar_chofer" class="btn btn-primary">Agregar</button>
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                </form>
