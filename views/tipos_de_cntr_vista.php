                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a title="Editar" data-toggle="modal" data-target="#editar<?php echo $id; ?>"
                                        style="color: #17A589; padding:2%; ">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a title="Eliminar" href="../includes/delete_tipo_cntr.php?id=<?php echo $id; ?>"
                                        style="color: #17A589; padding:2%; ">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">
                                                Editar tipo de Contenerdo: <strong><?php echo $title; ?></strong></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="../formularios/edit_tipo_cntr.php?id=<?php echo $id; ?>"
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i
                                                                    class="ti-layout-column4-alt"></i></div>
                                                            <input type="mail" id="teu" name="teu"
                                                                value="<?php echo $teu; ?>" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3"></div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i class="ti-arrow-down"></i>
                                                            </div>
                                                            <input type="phone" id="weight" placeholder="Peso"
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i
                                                                    class="ti-arrows-vertical"></i></div>
                                                            <input type="phone" id="height" placeholder="Alto"
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i
                                                                    class="ti-arrows-horizontal"></i></div>
                                                            <input type="phone" id="width" name="width"
                                                                placeholder="Ancho" value="<?php echo $width; ?>"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3"></div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><i
                                                                    class="ti-arrows-corner"></i></div>
                                                            <input type="phone" id="long" name="long"
                                                                placeholder="Largo" value="<?php echo $long; ?>"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3"></div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-6">
                                                        <div class="input-group">
                                                            <textarea name="obervation" id="observation" cols="45"
                                                                rows="10"><?php echo $observation; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3"></div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col col-md-2">
                                                        <button type="submit" class="btn btn-info" name="editar_tipo"
                                                            id="editar_in">Editar</button>
                                                    </div>
                                                    <div class="col col-md-5"></div>
                                                </div>
                                            </form>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mx-auto text-center">
                            ...
                            <button type="button" data-toggle="modal" data-target="#agregarATA"
                                class="btn btn-outline-primary">Agregar Contenedor</button>
                        </div>
                    </div>
                    ...
                    <form action="../formularios/edit_tipo_cntr.php?id=<?php echo $id; ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="number"
                                        name="weight" placeholder="2500">
                                </div>
                                <div class="col-sm-1 pt-2">
                                    <label class="form-control-label" style="text-align: end;">Alto:</label>
                                </div>
                                <div class="col-sm-1">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="phone"
                                        name="height" placeholder="2.59">
                                </div>
                                <div class="col-sm-1 pt-2">
                                ...
                                <div class="col-sm-1">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="phone"
                                        name="width" placeholder="2.44">
                                </div>
                                <div class="col-sm-1 pt-2">
                                    <label class="form-control-label" style="text-align: end;">Largo:</label>
                                </div>
                                <div class="col-sm-1">
                                    <input class="form-control" style="margin-right: 1%; margin-left:1%;" type="decimal"
                                        name="longitud" placeholder="6.10">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mx-auto">
                                    <textarea name="observation" style="width: inherit;" id="" cols="100"
                                        rows="4"></textarea>
                                </div>
                            </div>
                        </div>
