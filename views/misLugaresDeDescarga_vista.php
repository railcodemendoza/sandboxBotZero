<div class="container">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM `customer_unload_place` WHERE `company` = '$empresa'";
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" style="color:blue; margin-left:30%;" href="<?php echo $link_maps; ?>"><i
                                    class="ti-map-alt"></i></a></td>
                        <td><?php echo $km_from_town; ?></td>

                        <td style="text-align:center;">
                            <a title="Editar Lugar de Carga" data-toggle="modal" data-target="#editar<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a title="Ver Lugar de Carga" data-toggle="modal" data-target="#ver<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a title="Eliminar" href="../includes/delete_lugarDeDescarga.php?id=<?php echo $id; ?>"
                                style="color: #17A589; padding:2%;">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar
                                    <strong><?php echo $description; ?></strong></h4>
                            </div>
                            <div class="modal-body">
                                <form action="../formularios/edit_lugarDeDescarga.php?id=<?php echo $id; ?>"
                                    method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" style="margin-right: 1%; margin-left:1%;"
                                                type="text" name="km_from_town" value="<?php echo $km_from_town; ?>">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" style="margin-right: 1%; margin-left:1%;"
                                                type="text" name="lat_lon" value="<?php echo $lat_lon; ?>">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_lugarDeDescarga"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <iframe target="_blank"
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d427205.3967266963!2d-69.31506633014509!3d-33.226097144803376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x967c35cb7f24f40f%3A0x3ad7660e3f93e17c!2sBodega%20Salentein!5e0!3m2!1ses!2sar!4v1592260291031!5m2!1ses!2sar"
                                            width="230" height="250" frameborder="0" style="border:0;"
        ...
        <form action="../Report_Customer/misLugaresDeDescarga.php" method="POST">
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA"
                        class="btn btn-outline-primary">Agregar Lugar de Descarga</button>
                </div>
            </div>
        </form>
        <br>
...
<div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Lugar de
                        Descarga</strong>
                </h4>
            </div>
            <div class="modal-body">
                <form action="../formularios/misLugaresdeDescargas.php" method="POST">
                    <div class="row form-group">
                        <div class="col-sm-2 pt-2">
                            <label class="form-control-label" for="">Descripción:</label>
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="description" placeholder="Empresa SA"
                                required>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" style="margin-right: 1%; " type="text" name="link_maps"
                                placeholder="-33.022036,-68.864257">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-2 pt-2">
                        ...
                        <div class="col-sm-3">
                            ...
                            <small class="help-block form-text"> <a href="">para lugares de carga fuera de zona.</a>
                            </small>
                        </div>
                    </div>
                    <div class="row form-group">
