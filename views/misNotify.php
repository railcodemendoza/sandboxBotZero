...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM `customer.ntfy` WHERE `company` ='$empresa'";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a title="Editar Notify" data-toggle="modal" data-target="#editar<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a title="Ver Notify" data-toggle="modal" data-target="#ver<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a title="Eliminar" href="../includes/delete_Notify.php?id=<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar Notify <strong></strong></h4>
                            </div>
                            <div class="modal-body">
                                <form action="../formularios/edit_notify.php?id=<?php echo $id; ?>" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_notify" class="btn btn-primary">Editar</button>
                                        </div>
                                        <div class="col-sm-2">
        ...
        <form action="../Report_Customer/misNotify.php" method="POST">
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregarATA" class="btn btn-outline-primary">Agregar Notify</button>
...
<div class="modal fade" id="agregarATA" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Notify</strong>
                </h4>
            </div>
            <div class="modal-body">
                <form action="../formularios/misNotify.php" method="POST">
                    <div class="row form-group">
                        <div class="col-sm-2 pt-2">
                            <label class="form-control-label" for="">Razon Social:</label>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="tax_id" placeholder="CUIT / RUT / NIT" required>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-2 pt-2">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-5"></div>
                        <div class="col-sm-2">
                            <button type="submit" name="cargar_notify" class="btn btn-primary">Agregar Notify</button>
                        </div>
                        <div class="col-sm-5"></div>
