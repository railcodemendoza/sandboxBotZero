                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a title="Editar Shipper" data-toggle="modal" data-target="#editar<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a title="Ver Shipper" data-toggle="modal" data-target="#ver<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a title="Eliminar" href="../includes/delete_shipper.php?id=<?php echo $id; ?>"
                                style="color: #17A589; padding:2%; ">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar Shipper
                            ...
                            <div class="modal-body">
                                <form action="../formularios/edit_shipper.php?id=<?php echo $id; ?>" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2 mt-1">
                                            <label class="form-control-label">Comentarioss:</label>
                                        </div>
                                        <div class="col-sm-3 mt-1">
                                            <textarea name="remarks" placeholder="<?php echo $remarks; ?>" cols="85"
                                                rows="5" class="form-control"><?php echo $remarks; ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="editar_shipper"
        ...
        <form action="../Report_Customer/misShipper.php" method="POST">
            <div class="row">
                <div class="col-sm-6 mx-auto text-center">
                    ...
                    <button type="button" data-toggle="modal" data-target="#agregar"
                        class="btn btn-outline-primary">Agregar Shipper</button>
                </div>
            </div>
        </form>
        <br>
...
<div class="modal fade" id="agregar" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel"><strong>Agregar Shipper</strong>
                </h4>
            </div>
            <div class="modal-body">
                <form action="../formularios/misShipper.php" method="POST">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" name="tax_id" placeholder="CUIT / RUT / NIT"
                                required>
                            <p>(sin guiones)</p>
                        </div>
                    </div>
