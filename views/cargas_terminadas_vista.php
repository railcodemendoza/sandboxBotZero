...
<div class="container">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM carga WHERE status = 'TERMINADA'";
                    ...
                    while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a title="Ver Carga" href="../includes/view_carga_user.php?id=<?php echo $row['id'] ?>" class="btn btn-success">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>
        ...
        <form action="../Reporte_user_basic/misCargasTerminadas.php" method="POST">
            <div class="row">
