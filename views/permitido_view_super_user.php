...
<head>
    ...
    <title>BOT.zero :: PERMITIDO</title>
            ...
            <div class="animated fadeIn">
                <div class="card">
                    <div style="text-align:center;" class="card-header">
                        <strong class="card-title">Usuarios para habilitar</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM `users` WHERE permiso IS NULL";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a title="Editar" data-toggle="modal" data-target="#permiso<?php echo $id; ?>" style="color: #17A589; padding:2%; ">
                                    ...
                                    <div class="modal fade" id="permiso<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 style="text-align:center;" class="modal-title" id="scrollmodalLabel">Editar Usuario:
