...
$query = "SELECT id, razon_social, CUIT, IIBB, name_admin, mail_admin, cel_admin, name_logistic, mail_logistic, cel_logistic, direccion, Provincia, pais FROM empresas ";
