    ...
    $query_sandbox = "SELECT * FROM `variables` WHERE sandbox = 1";
    $result_sandbox = mysqli_query($conn, $query_sandbox);
    if (mysqli_num_rows($result_sandbox) == 1) {
        $sandbox = 'SANDBOX';
    }
    ?>
    <div id="right-panel" class="right-panel">
            ...
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        <img src="../images/piotterHorizontalBlanco.png"
                            style="width:auto; height: 36px; margin-left: 15%;" alt="Logo"></a>
            ...
            <div class="top-right">
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media"
                                    href="../marcar_leido.php?id=<?php echo $id_pro; ?>&cntr_number=<?php echo $cntr_number_pro; ?>&booking=<?php echo $booking_pro; ?>">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media"
                                    href="../satisfaccion/satisfaccion_carga.php?cntr_number=<?php echo $cntr_number_ter; ?>&booking=<?php echo $booking_ter; ?>">
                                    <i class="fa fa-check"></i>
                        ...
                        <div class="dropdown for-notification">
                            ...
                            ?>
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="notification"
                                data-toggle="dropdown" aria-haspopup="´flase" aria-expanded="true">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media"
                                    href="../marcar_leido_as.php?id=<?php echo $id_as; ?>&cntr_number=<?php echo $cntr_number_as; ?>&booking=<?php echo $booking_as; ?>">
                                    <i class="fa fa-check"></i>
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                <a href="../mensajes/index.php">
                                    <p class="red">You have <?php echo $cantidad_msj; ?> Mails</p>
                                </a>
                                <?php
                    ...
                    <div class="user-area dropdown float-right">
                        <a style="text-transform: capitalize; color: white; Baloo Tamma 2', cursive;" href="#"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            user: <?php echo " " . $usuario; ?>
                        </a>
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="../views/misDatos<?php echo $direct; ?>"><i
        ...
        <header style="background: transparent; margin:3% 20% 2% 35%; border-block-end: inherit;" id="header"
            class="header">
            <div class="row">
                <div class="col-sm-5 mx-auto">
                    <h1 class="text-secondary text-center"><?php echo $sandbox; ?></h1>
                </div>
            </div>
            <?php
