            ...
            <div class="card-group">
                <div class="card col-md-6 no-padding mr-1 " style="background: #243a4d;">
                    <div class="card-body">
                        ...
                        <h5 style="text-align: center; color:#cbece9; min-height: 2.5rem;">--</h5>
                ...
                <div class="card col-md-6 no-padding mr-1 " style="background: #243a4d;">
                    <div class="card-body">
                        ...
                        <h5 style="text-align: center; color:#cbece9 ; min-height: 2.5rem;"><?php echo $custom_place; ?></h5>
                        <div style="text-align: center; color:green;">
                ...
                <div class="card col-md-6 no-padding mr-1 " style="background: #243a4d;">
                    <div class="card-body">
                        ...
                        <h5 style="text-align: center; color:#cbece9; min-height: 2.5rem;"><?php echo $unload_place; ?></h5>
                        <div style="text-align: center; color:green;">
