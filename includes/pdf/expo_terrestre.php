        ...
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.5rem 0 0.5rem 1rem; font-size: medium;">CARGA CAMION CON BARANDA Y LONA</p>';
        ...
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Referencia: <small style="font-family: sans-serif; color: gray ; font-size: medium;">'.$cntr_number.'</small></p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Peso: <small style="font-family: sans-serif; color: gray ;font-size: medium;">'.$net_weight.' TONS</small></p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Exportador: <small style="font-family: sans-serif; color: gray ;font-size: medium;">'.$shipper.' TONS</small></p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Lugar de Carga: <small style="font-family: sans-serif; color: gray ;font-size: medium;">'.$load_place.' | </small> Fecha de Carga:<small style="font-family: sans-serif; color: gray ;margin: 0.5rem 0 0.5rem 1rem;font-size: medium;">'.$load_date . '</small>| Direccion: <small style="font-family: sans-serif; color: gray ;margin: 0.5rem 0 0.5rem 1rem;font-size: medium;"><a href="'. $link_maps .'"> ' . $address . ' - ' . $city . '</small></a></p></small></p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Lugar de Aduana Expo: <small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$custom_place.' |</small> Despachante Expo:<small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$custom_agent.'</small> </p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Lugar de Aduana Impo: <small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$custom_place_impo.' |</small> Despachante Impo:<small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$custom_agent_impo.'</small> </p>';
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Puerto de Descarga: <small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$unload_place.' | </small> Cut Off Fisico:<small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$cut_off_fis.'</small> </p>';
        ...
        $content .= '<p style="font-family: sans-serif; text-align: left; margin: 0.2rem 0 0.2rem 1rem; font-size: medium;">Agencia de Ingreso: <small style="font-family: sans-serif; color: gray ;font-size: medium;"> '.$agent_port.' | </small>Contacto:<small style="font-family: sans-serif; color: gray ;font-size: medium;"></small> </p>';
