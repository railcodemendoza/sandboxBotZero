...
$query = "SELECT carga.booking, cntr.cntr_number, carga.unload_place, carga.final_point, carga.ETD, carga.shipper, carga.Empresa from cntr INNER JOIN carga ON carga.booking = cntr.booking where cntr.main_status = 'ON BOARD'";
