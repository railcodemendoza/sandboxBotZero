...
if (isset($_POST['agregar_in'])){
      ...
      $query = "INSERT INTO `profit`(`cntr_number`, `in_usd`, `in_razon_social`, `in_detalle`,`user`) VALUES ('$cntr_number','$in_usd', '$in_razon_social', '$in_detalle', '$user')";
...
if (isset($_POST['agregar_out'])){
  ...
  $query = "INSERT INTO `profit`(`cntr_number`, `out_usd`, `out_razon_social`, `out_detalle`,`user`) VALUES ('$cntr_number','$out_usd', '$out_razon_social', '$out_detalle', '$user')";
  $result = mysqli_query($conn, $query);
